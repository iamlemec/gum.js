import { MapMode, EditorSelection, EditorState, Transaction, Prec, StateEffect, Facet, ChangeSet, RangeSet, findColumn, Text, codePointAt, codePointSize, combineConfig, RangeValue, findClusterBreak, CharCategory } from '../../state/dist/index.js';
...
export { BidiSpan, BlockInfo, BlockType, Decoration, Direction, EditorView, GutterMarker, ViewPlugin, ViewUpdate, WidgetType, drawSelection, gutterLineClass, gutters, keymap, lineNumberMarkers, lineNumbers, logException };
