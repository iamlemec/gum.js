...
let Gum = [
    ...
    Axes, Graph, Plot, range, linspace, zip, exp, log, sin, cos, min, max, sqrt, InterActive,
    Variable, Slider
];
...
export {
    ...
    linspace, exp, log, sin, cos, min, max, sqrt, Context, Element, Container, Group, SVG,
    Frame, VStack, HStack, Place, Points, Spacer, Ray, Line, Rect, Square, Ellipse, Circle,
    Polyline, Polygon, Path, Text, Tex, Node, MoveTo, LineTo, Bezier2, Bezier3, Arc, Close,
    SymPath, Scatter, XScale, YScale, XAxis, YAxis, Axes, Graph, Plot, InterActive, Variable,
    Slider
};
