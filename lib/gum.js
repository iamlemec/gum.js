...
class Axes extends Container {
    constructor(args) {
        let {xticks, yticks, xticksize, yticksize, xlim, ylim, aspect, prec, ...attr} = args ?? {};
        xticks = xticks ?? 5;
        yticks = yticks ?? 5;
        xticksize = xticksize ?? tick_size_base;
        yticksize = yticksize ?? tick_size_base;
        ...
        if (xaxis != null) {
            children.push([
                xaxis, [0, 1-xticksize/2, 1, 1+xticksize/2]
            ]);
        }
        if (yaxis != null) {
            children.push([
                yaxis, [-yticksize/2, 0, yticksize/2, 1]
            ]);
        }
...
class Plot extends Container {
    constructor(lines, args) {
        ...
        // create axes
        let axes = new Axes({
            xticks: xticks, yticks: yticks, xticksize: xticksize, yticksize: yticksize,
