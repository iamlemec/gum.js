...
class Bezier3 extends Command {
    constructor(x, y, x2, y2, x1, y1) {
        ...
        if (x1 == null || y1 == null) {
            ...
            let point2 = [x2, y2];
            super('C', ['xy', 'xy'], [point1, point2, point]);
        }
    }
}
...
let Gum = [
    ...
    LineTo, Bezier2, Bezier3, Arc, Close, range, linspace
];
...
export {
    ...
    Spacer, Ray, Rect, Square, Ellipse, Circle, Polyline, Polygon, Path, Text, Node, MoveTo, LineTo,
    Bezier2, Bezier3, Arc, Close
};
