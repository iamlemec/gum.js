...
class Context {
    ...
    frac_to_pixel(pos) {
        ...
        return pos.map(([zx, zy]) => [
            pix ? px2 + zx*pw : px1 + zx*pw,
            piy ? py2 + zy*ph : py1 + zy*ph
        ]);
    }
...
let Gum = [
    ...
    Graph, Plot, range, linspace, exp, log, sin, cos, min, max, InterActive, Variable, Slider
];
...
export {
    ...
    HStack, Place, Points, Spacer, Ray, Rect, Square, Ellipse, Circle, Polyline, Polygon, Path,
    Text, Tex, Node, MoveTo, LineTo, Bezier2, Bezier3, Arc, Close, SymPath, Scatter, XScale, YScale,
    XAxis, YAxis, Axes, Graph, Plot, InterActive, Variable, Slider
};
