...
class Toggle extends Variable {
    ...
    anchor(name, targ, ctx, redraw) {
        ...
        let checkinner = `<span class="toggle-indicator">
...
let Gum = [
    ...
    Axes, Graph, Plot, range, linspace, exp, log, sin, cos, min, max, sqrt, InterActive, Variable,
    Slider, Toggle
];
...
export {
    ...
    VStack, HStack, Place, Points, Spacer, Ray, Line, Rect, Square, Ellipse, Circle, Polyline,
    Polygon, Path, Text, Tex, Node, MoveTo, LineTo, Bezier2, Bezier3, Arc, Close, SymPath, Scatter,
    XScale, YScale, XAxis, YAxis, Axes, Graph, Plot, InterActive, Variable, Slider, Toggle
};
